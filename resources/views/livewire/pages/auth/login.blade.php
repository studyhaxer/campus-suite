        ...
        <div class="w-full max-w-sm">
            ...
            <form wire:submit="login" class="mt-8 space-y-5">
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative">
                        <input wire:model="password" :type="show ? 'text' : 'password'" id="password" required autocomplete="current-password"
                ...
                <label class="flex items-center gap-2.5">
                    <input wire:model="remember" type="checkbox" class="rounded border-ink/25 text-gold focus:ring-gold">
                    <span class="text-sm text-slate">Keep me signed in</span>
                </label>

                <button type="submit" wire:loading.attr="disabled" wire:target="login"
                    class="w-full inline-flex items-center justify-center gap-2 bg-ink text-parchment font-medium px-6 py-3.5 rounded-md hover:bg-ink/90 disabled:opacity-60 transition-colors">
